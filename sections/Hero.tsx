        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div
                    ...
                    style={{ background: "radial-gradient(circle, #04A63D 0%, transparent 70%)" }}
                />
            </div>
            ...
            {floatingElements.map((el, i) => (
                <motion.div
                    ...
                    transition={{ duration: 6 + i, repeat: Infinity, ease: "easeInOut", delay: el.delay }}
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-xs font-medium text-primary-500 tracking-widest uppercase">
                            Platform Engineering #1 Indonesia
                        </span>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.8, delay: 2.1, ease: [0.25, 0.1, 0.25, 1] }}
                        className="mb-6"
                    >
                    ...
                    >
                        Platform kursus online untuk{" "}
                        <span className="text-theme-primary font-medium">teknik sipil</span> dan{" "}
                        <span className="text-theme-primary font-medium">struktur bangunan</span>.
                        Kuasai ilmu engineering dari instruktur berpengalaman di industri.
                    </motion.p>
            ...
            >
                <span className="text-[10px] text-theme-muted tracking-widest uppercase">Scroll</span>
                <motion.div
                    animate={{ y: [0, 6, 0] }}
